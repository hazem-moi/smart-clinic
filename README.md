...
- تسجيل دخول/إنشاء حساب (مريض أو طبيب) مع JWT وتشفير bcrypt.
- المريض: تصفية الأطباء حسب التخصص، حجز موعد بخانات زمنية ضمن دوام الطبيب، إلغاء المواعيد القادمة، وتقييم الطبيب بعد الفحص.
- الطبيب: عرض مواعيد اليوم، تحديث حالة الموعد، وكتابة الوصفة الطبية.
- تجربة المستخدم: عربية RTL، وضع ليلي، وشارات ملوّنة لحالات المواعيد.
- قاعدة بيانات من خمسة جداول: users, specialties, doctors (بأوقات دوام), appointments, reviews.
